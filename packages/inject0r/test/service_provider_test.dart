...
void main() {
  group('ServiceProvider', () {
    late ServiceProvider<String> serviceProvider;
    ...
    group('registerSingleton', () {
      ...
      test('adds a singleton provider with correct type', () {
        ...
        final provider = serviceProvider.providers.first as Provider<int, String>;
    ...
    group('registerScoped', () {
      test('adds a scoped provider', () {
        ...
        expect(serviceProvider.providers, hasLength(1));
        expect(serviceProvider.providers.first.providerType, ProviderType.scoped);
      });
    ...
    group('registerTransient', () {
      test('adds a transient provider', () {
        ...
        expect(serviceProvider.providers, hasLength(1));
        expect(serviceProvider.providers.first.providerType, ProviderType.transient);
      });
    ...
    group('multiple registrations', () {
      test('can register multiple providers of different types', () {
        ...
        expect(serviceProvider.providers[0].providerType, ProviderType.singleton);
        expect(serviceProvider.providers[1].providerType, ProviderType.scoped);
        expect(serviceProvider.providers[2].providerType, ProviderType.transient);
      });

      test('can register multiple providers of the same type with different keys', () {
        serviceProvider.registerScoped<int>(
          create: (_) => 1,
          key: 'first',
        );
      ...
      test('create function receives context', () {
        ...
        final provider = serviceProvider.providers.first as Provider<String, String>;
